...
<tr<?php echo $triggable; ?>>
	...
	<td>
		<div class="nb-icon-picker">
			<input type="text" value="<?php echo $settings[$option['id']]; ?>" name="<?php echo $option['id']; ?>" id="nb-field-<?php echo $option['id']; ?>" class="regular-text nb-icon-picker-value nb-prevent-clickout" style="width:270px" />
			<img src="<?php echo $settings[$option['id']]; ?>" alt="<?php _e( 'Preview', NB_TEXTDOMAIN ); ?>" class="nb-icon-picker-preview" data-id="<?php echo $option['id']; ?>" />
